...
<body id="login">
<img src="asset/image/logiin.png" id="logo-login" style="height: 100px">
...
<div id="panel-login" style="margin-top: -20px">
    <form id="formlogin" method="POST" action="ceklogin.php">
        ...
        <button class="btn btn-black btn-full"><i class="fa fa-arrow-alt-circle-right text-white"></i> Login</button>
    </form>
</div>
<img src="asset/image/black_stars.png" id="hiasan" style="height: 250px"><br>
</body>
